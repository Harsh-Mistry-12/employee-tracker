...
class TimeClock:
    ...
    def punch_in(self):
        if self.start_time is not None:
            QMessageBox.warning(self.ui.centralwidget, 'Already Punched In', 'You are already punched in.')
            return
        ...
        QMessageBox.information(self.ui.centralwidget, 'Punch In Successful', 'You have successfully punched in.')
    ...
    def punch_out(self):
        ...
        self.ui.label_4.setText(self.end_time.strftime("%H:%M:%S"))  # Update label with end time
        print("Punched out at:", self.end_time)
        QMessageBox.information(self.ui.centralwidget, 'Punch Out Successful', 'You have successfully punched out.')
...
"}")
    ...
    def retranslateUi(self, ActiveTracker):
        ...
        self.label_4.setText(_translate("ActiveTracker", "00:00:00"))
        ...
        self.label_9.setText(_translate("ActiveTracker", "00:00:00"))
